...
class Recipe:
    ...
    def submit_recipe(cls, data):
        query = "INSERT INTO recipes (name, time, description, instructions, date, users_id) VALUES (%(name)s, %(time)s, %(description)s, %(instructions)s, %(date)s, %(users_id)s);"
    ...
    def edit_recipe(cls, data):
        query = "UPDATE RECIPES SET name=%(name)s, time=%(time)s, description=%(description)s, instructions=%(instructions)s, date=%(date)s WHERE id = %(id)s;"
